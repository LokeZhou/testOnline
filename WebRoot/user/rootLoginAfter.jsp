                ...
                <div class="col-sm-6 col-md-6 height-100p bounceInLeft wow" data-wow-duration="1.3s"
                    ...
                    <div class="vertical-middle">
                        ...
                        <div class="text-white h4">
                         ...
                         <a href="${pageContext.request.contextPath }/user/upload.action" class="smooth-scroll btn btn-theme"  style="background-image: none">上传题目</a>
                    </div>
                </div>
            ...
            <div class="row height-100p">
                ...
                <div class="col-sm-6 col-md-6 height-100p bounceInLeft wow" data-wow-duration="1.3s"
                    ...
                    <div class="vertical-middle">
                        ...
                        <a href="${pageContext.request.contextPath }/user/checkLibrary.action" class="smooth-scroll btn btn-theme"  style="background-image: none">查看题库</a>
                    </div>
                </div>
