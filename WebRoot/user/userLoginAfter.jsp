            ...
            <div class="row height-100p">
                ...
                <div class="col-sm-6 col-md-6 height-100p bounceInLeft wow" data-wow-duration="1.3s"
                    ...
                    <div class="vertical-middle">
                        <h1 class="text-white">欢迎进行 <span class="text-theme">在线测试</span></h1>
                        <div class="text-white h4">
                             Upgrade  platinum user
                        </div>
                         <a href="${pageContext.request.contextPath }/user/Upgrade.action" class="smooth-scroll btn btn-theme"  style="background-image: none">账号升级</a>
                    </div>
                </div>
            ...
            <div class="row height-100p">
                ...
                <div class="col-sm-6 col-md-6 height-100p bounceInLeft wow" data-wow-duration="1.3s"
                    ...
                    <div class="vertical-middle">
                        ...
                        <a href="${pageContext.request.contextPath }/user/checkRecord.action" class="smooth-scroll btn btn-theme"  style="background-image: none">查看历史</a>
                    </div>
                </div>
